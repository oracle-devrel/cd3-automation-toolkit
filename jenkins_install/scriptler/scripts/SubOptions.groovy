...
List developer_services = ["<b>DEVELOPER SERVICES</b>:disabled","Upload current terraform files/state to Resource Manager", "Add/Modify/Delete OKE Cluster and Nodepools"]
