...
List database = ["<b>DATABASE</b>:disabled","Add/Modify/Delete Virtual Machine or Bare Metal DB Systems", "Add/Modify/Delete EXA Infra and EXA VM Clusters", "Add/Modify/Delete Exa DB Homes", "Add/Modify/Delete Exa Databases(CDBs)", "Add/Modify/Delete Exa PDBs", "Add/Modify/Delete ADBs", "Add/Modify/Delete MySQL DBs"]
...
List ex_databases = ["<b>DATABASE</b>:disabled","Export Virtual Machine or Bare Metal DB Systems", "Export EXA Infra and EXA VMClusters", "Export ADBs", "Export EXA Infra DB Homes", "Export EXA Infra Databases(CDBs)", "Export EXA Infra PDBs", "Export MySQL DBs"]
