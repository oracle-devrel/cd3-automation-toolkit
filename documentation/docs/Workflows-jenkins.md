...
* The configurations are done when you execute createTenancyConfig.py in [Connect container to OCI Tenancy](Connect_container_to_OCI_Tenancy.md). Please validate them:
