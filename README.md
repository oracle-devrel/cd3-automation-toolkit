...
- <a href = "/cd3_automation_toolkit/documentation/user_guide/Launch_Docker_container.md">Launch the container</a> - <i> Skip this step if you are using 'Deploy To Oracle Cloud' button. </i>
