...
!!! Note 
    Azure Cloud@DB Terraform execution uses the Azure Verified Module Azure/avm-res-network-virtualnetwork/azurerm version 0.17.1. 
    This third-party module enforces its own Terraform runtime requirements. 
