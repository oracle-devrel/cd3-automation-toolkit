...
!!! note 
    ...
    3. As of the CD3 v2025.1.0, the export of FSS is supported only by Regions and Compartments, not based on Tags. 
...
**13. Terraform Forces Resource Replacement – OCI CDB with Database Management Enabled** <br>
<br>
**Issue Description**
