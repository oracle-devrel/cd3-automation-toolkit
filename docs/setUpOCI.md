# **Set Up OCI using Automation Toolkit**
---

To create/manage OCI services supported by CD3, users should complete the steps to <a href="../install-cd3"><u>Install the CD3 toolkit</u></a> and then <a href = "../connect-container-to-oci-tenancy"><u>Connect to OCI</u></a> 
