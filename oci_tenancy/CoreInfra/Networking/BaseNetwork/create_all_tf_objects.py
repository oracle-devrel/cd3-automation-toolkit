...
#parser.add_argument("--createCompartment", help="create compartments y | n | Default is n", required=False)
...
#if(args.createCompartment is not None):
#    createCompartment=args.createCompartment
#else:
#    createCompartment = 'n'
