...
# Attach the tags created to the volumes
import sys
import argparse

parser = argparse.ArgumentParser(description="Create vars files for the each row in csv file.")
parser.add_argument("file", help="Full Path of CSV file.Ex:tag_volume-csv-example.csv in example folder")
