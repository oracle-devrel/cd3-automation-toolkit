...
parser.add_argument("--serverList",help="Comma seprated list of server with respective compartmnet name[serverName,CompartmentName]")
...
for compartment in compSet:
	...
	for instance in base_list:
                if instance.display_name.lower() in serverListDict:
                	#cc.instance_action(instance.id,"STOP")
			print("Restarting " + instance.display_name +" from compartment :: " +compartment)
			cc.instance_action(instance.id,"SOFTRESET")
