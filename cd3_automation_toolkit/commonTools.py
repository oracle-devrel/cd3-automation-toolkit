...
class commonTools():
    ...
    tagColumns = {'freeform tags', 'freeform_tags', 'defined_tags', 'defined tags', 'vnic defined tags', 'vnic_defined_tags', 'vnic freeform tags', 'vnic_freeform_tags', 'oke_labels', 'oke labels','nodepool defined tags', 'nodepool_defined_tags', 'node defined tags', 'node_defined_tags','nodepool freeform tags', 'nodepool_freeform_tags', 'node freeform tags', 'node_freeform_tags'}
    ...
    def export_tags(oci_obj, header, values_for_column):
        ...
        if 'defined' in str(header).lower():
            ...
            for labels in (oci_obj.__getattribute__('initial_node_labels')):
