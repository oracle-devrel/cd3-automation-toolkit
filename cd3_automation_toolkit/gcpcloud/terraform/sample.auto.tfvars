...
gcp_oci_exa_vmclusters = {
  ...
  dev_vm_cluster = {
    ...
    exadata_infrastructure_id = "exadev"
    odb_network_id            = "odbnetwork1"
    odb_client_subnet_id      = "odb-subnet1"
    odb_backup_subnet_id      = "backup-subnet"

    create_odb_network          = true
    vpc_network_name            = "demo-base-vpc"
    odb_network_gcp_oracle_zone = "us-east4-b-r1"
    client_subnet_cidr          = "10.1.0.0/24"
    backup_subnet_cidr          = "10.2.0.0/24"

    # MANDATORY: Configuration
    cloud_vm_cluster_id = "dev-cluster"
    display_name        = "DEV_CLUSTER"
    ...
    memory_size_gb          = 60  # Minimum 30 GB per node.
    data_storage_size_tb    = 2.0 # Minimum 2.0 TB.
    db_node_storage_size_gb = 120 # Range: 120 GB to 1200 GB.
    ssh_public_keys         = ["ssh-rsa AAAAB3Nza... user@host"]

    # OPTIONAL: Configuration (With defaults)
    license_type           = "LICENSE_INCLUDED" # "LICENSE_INCLUDED" | "BRING_YOUR_OWN_LICENSE"
    time_zone              = "UTC"              # Default: "UTC". Supports standard TZ database names.
