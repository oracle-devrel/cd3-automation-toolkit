...
def parse_args():
    # Read the arguments
    parser = argparse.ArgumentParser(description="Create DNS-Resolver terraform file")
...
if __name__ == '__main__':
    ...
    args = parse_args()
    create_terraform_dns_resolvers(args.inputfile, args.outdir, args.service_dir, args.prefix, args.config)
