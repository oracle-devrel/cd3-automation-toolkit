...
def parse_args():
    # Read the arguments
    parser = argparse.ArgumentParser(description="Create DNS-Views terraform file")
...
if __name__ == '__main__':
    ...
    args = parse_args()
    create_terraform_dns_views(args.inputfile, args.outdir, args.service_dir, args.prefix, args.config)
