# ========================================
# Module: aws-oci-exa-vmcluster / main.tf
# ========================================

data "aws_odb_cloud_exadata_infrastructures" "all" {}
data "aws_odb_networks" "all" {}

# create_odb_network = true  → ID passed directly from the network module
# create_odb_network = false → look up existing network by display_name
