...
def  print_notifications(values_for_column_notifications,region, ntk_compartment_name, sbpn, nftn_info, i, fun,state):
    ...
    for col_header in values_for_column_notifications.keys():
        if (col_header == "Region"):
            ...
            values_for_column_notifications = ociCommonTools.export_extra_columns(oci_objs, col_header, sheet_dict_notifications,values_for_column_notifications)
    tf_resource = f'module.notifications[\\"{tf_name_nftn}\\"].oci_ons_notification_topic.topic'
