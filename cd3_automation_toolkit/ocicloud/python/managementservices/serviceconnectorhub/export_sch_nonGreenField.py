    ...
    for schs in SCH_LIST.data:
        ...
        for col_header in values_for_column:
            ...
            #     values_for_column[col_header].append(stream_partitions)
                ...
                values_for_column = ociCommonTools.export_tags(schs, col_header, values_for_column)
            else:
                oci_objs = [schs]
                values_for_column = ociCommonTools.export_extra_columns(oci_objs, col_header, sheet_dict,
                                                                     values_for_column)
