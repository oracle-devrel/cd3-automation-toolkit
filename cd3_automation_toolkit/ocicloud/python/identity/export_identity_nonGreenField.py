            ...
            if (c_id not in comp_ocids_done):
                ...
                for col_header in values_for_column_comps.keys():
                    if (col_header == "Region"):
                        ...
                        values_for_column_comps = ociCommonTools.export_tags(c_details, col_header,
                        ...
                        if (count == 1):
                            for col_header in values_for_column_policies.keys():
                                if (col_header == "Region"):
                                    ...
                                    values_for_column_policies = ociCommonTools.export_tags(policy, col_header,
        ...
        def process_group(grp_info, members_list,membership_id_list, domain_name, is_dynamic=False, importCommands="", values_for_column_groups={}, non_domain=False):
            ...
            for col_header in values_for_column_groups.keys():
                if col_header == "Region":
                    ...
                    values_for_column_groups = ociCommonTools.export_tags(grp_info, col_header, values_for_column_groups)
                else:
                    oci_objs = [grp_info]
                    values_for_column_groups = ociCommonTools.export_extra_columns(oci_objs, col_header, sheet_dict_groups, values_for_column_groups)
