...
def print_dedicatedvmhosts(region, dedicatedvmhost, values_for_column, ntk_compartment_name,export_compartments, export_regions, export_tags, state):
    ...
    for col_header in values_for_column:
        if col_header == 'Region':
            ...
            values_for_column = ociCommonTools.export_tags(dedicatedvmhost, col_header, values_for_column)
        else:
