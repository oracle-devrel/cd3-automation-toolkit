...
def adding_columns_values(region, ad, fd, vs, publicip, privateip, os_dname, shape, key_name, c_name,
    ...
    for col_header in values_for_column_instances.keys():
        if (col_header == "Region"):
            ...
            values_for_column_instances = ociCommonTools.export_tags(instance_data, col_header,
            ...
            values_for_column_instances = ociCommonTools.export_extra_columns(oci_objs, col_header, sheet_dict_instances,
                                                                           values_for_column_instances)
