...
def print_quotas(values_for_columns,region, quota,quota_policy):
    for col_header in values_for_columns.keys():
        if (col_header == "Region"):
            ...
            values_for_columns = ociCommonTools.export_tags(quota, col_header, values_for_columns)
        else:
            oci_objs = [quota]
            values_for_columns = ociCommonTools.export_extra_columns(oci_objs, col_header,
