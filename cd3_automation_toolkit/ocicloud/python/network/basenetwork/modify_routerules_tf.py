...
def modify_terraform_drg_routerules(inputfile, outdir, service_dir,prefix, ct, non_gf_tenancy):
    ...
    for i in df.index:
        ...
        if (DRG_RD_Name not in drgv2.drg_rds[DRG_Name,region] and  DRG_RD_Name.lower()!='nan' and DRG_RD_Name not in ociCommonTools.drg_auto_RDs):
        ...
        for columnname in dfcolumns:
            ...
            if(columnname == "Import DRG Route Distribution Name"):
                ...
                if columnvalue in ociCommonTools.drg_auto_RDs:
        ...
        if(len(rts_done[region])==0):
            ...
            if (DRG_RT not in ociCommonTools.drg_auto_RTs):
