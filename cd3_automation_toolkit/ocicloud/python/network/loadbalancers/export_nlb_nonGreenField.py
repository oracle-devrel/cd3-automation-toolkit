        ...
        for backendsets in eachnlb.__getattribute__('backend_sets'):
            ...
            for col_header in values_for_column_bss.keys():
                ...
                # Process the Tag  Columns
                    ...
                    if cnt_bss == 1:
                        values_for_column_bss = ociCommonTools.export_tags(eachnlb, col_header, values_for_column_bss)
                    else:
                        values_for_column_bss[col_header].append('')
                    ...
                    values_for_column_bss = ociCommonTools.export_extra_columns(oci_objs, col_header, sheet_dict_bss,values_for_column_bss)
        ...
        for listeners, values in eachnlb.__getattribute__('listeners').items():
            ...
            for col_header in values_for_column_lis.keys():
                ...
                # Process the Tag Columns
                    ...
                    if cnt_lsnr == 1:
                        values_for_column_lis = ociCommonTools.export_tags(eachnlb, col_header, values_for_column_lis)
                    else:
                        values_for_column_lis[col_header].append("")
                else:
                    oci_objs = [values,eachnlb,ips]
                    values_for_column_lis = ociCommonTools.export_extra_columns(oci_objs, col_header, sheet_dict_lis, values_for_column_lis)
