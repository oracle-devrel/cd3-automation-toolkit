...
* Run  ```docker exec -it <container_id> bash```
 ...
 <div align="left"><a href="/README.md#table-of-contents-bookmark">:arrow_backward:</a><div align="right"><a href="/cd3_automation_toolkit/documentation/user_guide/ConfiguringDockerContainer.md">:arrow_forward:</a></div>
