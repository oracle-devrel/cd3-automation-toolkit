...
|workflow\_type |greenfield workflow or non-greenfield workflow| create_resources for greenfield workflow. See <a href = /cd3_automation_toolkit/documentation/user_guide/Workflows.md> Automation Toolkit Workflows</a> for more information|
