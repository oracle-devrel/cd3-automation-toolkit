...
**Step 4**: 
<br>Click on Get Approval stage and click 'Proceed' to proceed with terraform apply or 'Abort' the terraform apply. It will wait for 24 hours before aborting the pipeline.
