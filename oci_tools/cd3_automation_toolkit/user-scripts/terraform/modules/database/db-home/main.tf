...
resource "oci_database_db_home" "new_database_db_home" {
  ...
  vm_cluster_id              = var.vm_cluster_id != null && var.exadata_infra_name != null ? data.oci_database_cloud_vm_clusters.existing_cloud_vm_cluster[0].cloud_vm_clusters[0].id : null
